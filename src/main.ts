...
function setMetadata() {
  const metadata: Record<string, { title: string; description: string; canonical: string }> = {
    ...
    '/demo': { title: 'Demo — Care Visit Brief', description: 'Try sample symptom notes that cannot change your private timeline.', canonical: '/?demo=1' },
  ...
  const current = metadata[viewRoute()] ?? { title: 'Page not found — Care Visit Brief', description: 'The requested Care Visit Brief page could not be found.', canonical: '/404.html' };
...
function notFound() { return `<main id="main" tabindex="-1" class="legal not-found"><p class="eyebrow">Page not found</p><h1 tabindex="-1">We could not find this page</h1><p>Return to your timeline or try the sample.</p><a class="button" href="/" data-route>Return home</a></main>`; }
